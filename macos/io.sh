...
# Trackpad: enable tap to click for this user & for the login screen (login not working)
...
# Trackpad: four finger expose & mission control
...
# Save screenshots in JPG format (other options: BMP, GIF, JPG, PDF, PNG, TIFF)
